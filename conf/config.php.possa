...
$conf['dbname']         = 'iaddress';         // database name
$conf['dbserver']       = 'localhost';           // server to connect to
$conf['dbuser']         = 'root';                    // username to connect to server
$conf['dbpass']         = 'passw0rd';                    // cleartext password to connect to server
...
$conf['title']       = 'POSSA iAddressBook';       // what to show in the title
$conf['template']    = 'possa';                // see tpl directory (the 'default' template is outdated)
...
$conf['auth_allow_guest'] = 1;                   // allow guest access (no login required) - the permissions can be conficured in conf/auth.php
$conf['im_convert']  = '/usr/bin/convert';       // path to ImageMagicks convert
$conf['photo_enable'] = 0;                       // enable photo usage (disable, if you are using sqlite 2.x)
